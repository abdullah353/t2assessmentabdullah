...
ResultsView = (function(_super) {
  ...
  ResultsView.prototype.cloud = function() {
    var _this = this;
    console.log("good do far");
    if (this.available.cloud.ok) {
      console.log("i am here"+Tangerine.config.address.local.dbName+','+ Tangerine.config.address.cloud.host + "/" + Tangerine.config.address.cloud.dbName );
